...
1\. Replace the text inside the brackets on the line that begins with “Evaluate” with the argument you want analyzed.

2\. After inserting your argument, copy everything starting from the line that begins with “Evaluate” down to the end of the document.

3\. Paste that content into the LMM of your choice.



Evaluate \[paste argument under evaluation between these brackets] using the following instructions:
