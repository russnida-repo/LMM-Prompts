# Argument Analysis, Technical Review, and Academic Publication‑Readiness Prompts

This repository contains **three high‑precision evaluation prompts** designed to support:

- **Structured argument analysis**
- **Technical report / white paper release assessment**
- **Academic paper publication‑readiness evaluation**
...
A complete, multi‑stage framework for analyzing the strength and structure of **any argument**.

### **What It Does**
- Extracts explicit premises & hidden assumptions  
- Rewrites the argument in formal logical structure  
- Tests:
  - **Validity** — does the conclusion logically follow?  
  - **Soundness** — are the premises defensible or true?  
- Clarifies ambiguous terms and reasoning methods  
- Stress‑tests the argument using:
  - Counterarguments  
...
A structured checklist‑driven evaluation for determining whether a **technical report or white paper** is ready for public release.
...
## **3. Academic Paper Publication‑Readiness Evaluation Prompt**
**File:**  
...
This prompt does **not** generate a formal peer‑review report.  
...
- Checks whether each major claim is supported by in‑paper evidence  
...
- Labs preparing early‑stage manuscripts  
...
They deliver **process‑based structure**, not subjective judgment, ensuring consistent evaluation regardless of which LLM is used.
...
- **Academic Paper Publication‑Readiness Evaluation Prompt**  
  https://github.com/russnida-repo/LMM-Prompts/blob/main/Prompts/Academic%20Paper%20Review%20Prompt.md  
...
- Build a Quick‑Start Guide for all three prompts  
